...
('saladas', 'Categoria de saladas'),
('sopas', 'Categoria de sopas'),
('massas', 'Categoria de massas'),
('carnes', 'Categoria de carnes'),
('frango', 'Categoria de frango'),
('peixes_e_frutos_do_mar', 'Categoria de peixes e frutos do mar'),
('lanches', 'Categoria de lanches'),
('petiscos', 'Categoria de petiscos'),
('sobremesas', 'Categoria de sobremesas'),
('bolos_e_tortas', 'Categoria de bolos e tortas'),
('bebidas', 'Categoria de bebidas'),
('vegano', 'Categoria vegana'),
('vegetariano', 'Categoria vegetariana'),
('light__fit', 'Categoria light/fit'),
('café_da_manhã', 'Categoria de café da manhã'),
('brunch', 'Categoria de brunch');
